    ...
    return (
        <div>
            <Card className={classes.card}>
                <CardMedia className={classes.media} onClick={handleOpen} image={post.selectedFile} title="{post.title}" />
            ...
            <Popup post={post} openPopup={isPopup} handleClose={handleClose}/>
        </div>
    )
}
